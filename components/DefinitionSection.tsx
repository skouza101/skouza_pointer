    ...
    <div className="space-y-8">
      <div className="bg-slate-800 p-8 rounded-2xl border border-slate-700 shadow-xl">
        ...
        <p className="text-lg text-slate-300 leading-relaxed mb-6">
          ...
          <strong className="text-primary">pointer</strong>{" "}
          {
            t.definition.description
              .split("pointer")[1]
              ?.split("memory address")[0]
          }
          <em className="text-accent not-italic mx-1">memory address</em>
          {t.definition.description.split("memory address")[1]}
        </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 my-8">
          <div className="bg-slate-900 p-6 rounded-lg border border-slate-700 font-mono text-sm">
            ...
            <div className="mt-4 text-slate-400 text-xs">
              {t.definition.storesValue}{" "}
              <span className="text-orange-400">95</span>{" "}
              {t.definition.directly}
            </div>
          </div>
          ...
          <div className="bg-slate-900 p-6 rounded-lg border border-slate-700 font-mono text-sm relative overflow-hidden">
            ...
            <span className="text-white">score</span>;
            <div className="mt-4 text-slate-400 text-xs">
              {t.definition.storesAddress}{" "}
              <span className="text-primary">{t.definition.address}</span>{" "}
              {t.definition.ofVariable}
            </div>
          </div>
        </div>
          ...
          <ul className="space-y-3">
            <li className="flex items-start">
              ...
              <span className="text-slate-300">
                <strong>{t.definition.addressOf}</strong>{" "}
                {t.definition.addressOfDesc}
              </span>
            </li>
            <li className="flex items-start">
              <span className="bg-slate-700 px-2 py-1 rounded font-mono text-accent mr-3">
              ...
              <span className="text-slate-300">
                <strong>{t.definition.dereference}</strong>{" "}
                {t.definition.dereferenceDesc}
              </span>
            </li>
          </ul>
        </div>
